...
void Obj_Loader::setup(std::string mesh_dir, std::string vs, std::string fs, GLuint& VaoId) {

	createMesh(mesh_dir);
	createBufferObjects(VaoId);
...
void Obj_Loader::createBufferObjects(GLuint& VaoId)
{
...
void Obj_Loader::drawObj(int object, GLuint VaoId, GLfloat* model, GLfloat* view, GLfloat* proj, bool singleColor, Vector4D color)
{
	glBindVertexArray(VaoId);
